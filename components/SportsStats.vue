...
const stats = [
  { name: 'Football', stat: '07', previousStat: '10', change: '12%', changeType: 'increase' },
  { name: 'Basketball', stat: '58', previousStat: '10', change: '2.02%', changeType: 'increase' },
  { name: 'Rugby', stat: '24', previousStat: '10', change: '4.05%', changeType: 'decrease' },
]
</script>

<template>
  <div class="mt-10">
    <h3 class="text-base font-semibold leading-6 text-gray-900">Sports</h3>
